...
<div class="container">
	...
	<div class="row mt-3" style="height: 50px; line-height:50px;">
		<div class="col-1">
			<img src="${pageContext.request.contextPath }/resources/img/BeeSeller.png" alt="Bootstrap" width="45" height="45" style="margin-right: 30px; position: relative; top: -5px; left: -5px;">
		</div>
